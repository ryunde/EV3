...
/**
 * Toinen ohjelmaluokka, joka toimii sovelluksena ja käynnistyessään selvittää
 * infrapunsasensorillaan edessä olevan esteen etäisyyden ja toimii sen mukaan.
 * Jos ei ole estettä havaittavissa, robotti liikkuu eteenpäin.
 * Mikäli este on liian lähellä, robotti pysähtyy, välkyttää punaista valoa,
 * pitää äänen, liikuttaa saksiaan, kääntyy ja jatkaa matkaa taas.
 *
